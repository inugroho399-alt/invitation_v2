...
export default function MusicPlayer({ isPlaying, onToggle }: MusicPlayerProps) {
  ...
  return (
    <div className="floating-action d-flex align-items-end flex-column">
      ...
      >
        {/* Speaker ON (Playing) */}
        <svg className="play" style={{ display: isPlaying ? 'block' : 'none' }} xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256">
        ...
        {/* Speaker OFF (Muted / Paused) */}
        <svg className="pause" style={{ display: !isPlaying ? 'block' : 'none' }} xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256">
